...
public class MainListener extends TestListenerAdapter {
	...
	private MainReport q2oReport = new MainReport();
	...
	public void countExecution() {
		try {
			count = 1;
			String reportsDirectoryPath = MainReport.getReportDirPath();
			...
			if (!dir.exists()) {
				...
				String desFile = reportsDirectoryPath
						...
						+ System.getProperty("file.separator") + "logo.jpeg";
				;
				MainReport.copyFile(surFile, desFile);
			...
			String execution = MainReport.getReportDirPath()
	...
	public void onTestFailure(ITestResult tr) {
		...
		failedLogFiles.add(MainReport.fileName);
		System.out
				.println("***************************** FAILED        *****************************");
	...
	public void onTestSkipped(ITestResult tr) {
		...
		skippedLogFiles.add(MainReport.fileName);
	}
	...
	public void onTestSuccess(ITestResult tr) {
		...
		passedLogFiles.add(MainReport.fileName);
